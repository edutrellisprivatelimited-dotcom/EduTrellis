...
urlpatterns = [
    ...
    path('store/api/signup/verify/', views.store_signup_verify, name='store_signup_verify'),
    path('store/api/signup/resend/', views.store_signup_resend, name='store_signup_resend'),
